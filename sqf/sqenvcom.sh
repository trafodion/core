...
then
  ...
  export LOG4CXX_LIB_DIR=/usr/lib64/apache-log4cxx-0.10.0/lib
  export LOG4CXX_INC_DIR=/usr/include/apache-log4cxx-0.10.0/include
fi
...
export LD_LIBRARY_PATH=$CC_LIB:$MPI_ROOT/lib/$MPILIB:$MY_SQROOT/export/lib"$SQ_MBTYPE":$HADOOP_LIB_DIR:$LOC_JVMLIBS:$LOG4CXX_LIB_DIR:.
