       ...
       , memLogBase_(NULL)
{
    ...
    sprintf(startTimeFmt_, "%02d%02d%02d.%02d.%02d.%02d", ltime->tm_year-100, ltime->tm_mon+1, ltime->tm_mday, ltime->tm_hour, ltime->tm_min, ltime->tm_sec);
