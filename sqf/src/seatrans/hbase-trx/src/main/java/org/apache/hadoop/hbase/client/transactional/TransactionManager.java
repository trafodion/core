...
*/
            ...
            if(state.toString().equals("VALID") && truncateList.size() > 0)
            {
                ...
                while (ci.hasNext())
                {
                    try {
                        ...
                        LOG.error("exception in abort, phase: truncateTable: " + e);
    ...
    public void registerTruncateOnAbort(final TransactionState transactionState, String tblName)
        ...
        try {
            ...
            PrintWriter pw = new PrintWriter(sw);
            e.printStackTrace(pw);
            LOG.error("registerTruncateOnAbort error: " + sw.toString());
        }
    }
    ...
    public void truncateTable(final TransactionState transactionState, String tblName)
        ...
        try {
            ...
            String msg = "ERROR enableTable exception: while calling hadmin truncateTable method";
            LOG.error(msg + ":" + e);
            throw new Exception(msg);
        }
    }
