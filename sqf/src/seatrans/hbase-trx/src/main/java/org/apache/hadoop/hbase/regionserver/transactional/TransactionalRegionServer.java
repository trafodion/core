...
//implements TransactionalRegionInterface {
  ...
  private IOException convertThrowableToIOE(final Throwable t, final String msg) {
	 ...
	 * @throws IOException
	 */
	private void abort(TransactionalRegion transRegion, long transId) throws IOException{
		try {
			...
			try {
				...
				LOG.error("checkAndDelete, autocommit is true, transID:" + transId, e1);
				throw e1;
			}
		} catch (Exception e2) {
