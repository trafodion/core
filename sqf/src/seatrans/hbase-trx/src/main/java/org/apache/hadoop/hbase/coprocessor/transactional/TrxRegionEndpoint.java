		...
		put = new Put(CellUtil.cloneRow(kv)); // kv.getRow()
              ...
              try {
                m_Region.put(put);
                 ...
                 LOG.warning("TrxRegionEndpoint coprocessor: commit - txId " + transactionId + ", Trafodion Recovery: Executing put caught an exception " + e.toString());
	   	...
	   	del = new Delete(CellUtil.cloneRow(kv));
	 	     ...
	 	     del.deleteFamily(CellUtil.cloneFamily(kv));
               ...
               try {
                 ...
                 LOG.warning("TrxRegionEndpoint coprocessor: commit - txId " + transactionId + ", Trafodion Recovery: Executing delete caught an exception " + e.toString());
//                 state.setStatus(Status.ABORTED);
//                 retireTransaction(state, true);
                 throw new IOException(e.toString());
                }
          ...
          if (LOG.isTraceEnabled()) LOG.trace("TrxRegionEndpoint coprocessor: commit - txId " + transactionId + ", Executing put directly to m_Region");
           try {
             m_Region.put(put);
              ...
              LOG.warning("TrxRegionEndpoint coprocessor: commit - txId " + transactionId + ", Executing put caught an exception " + e.toString());
//              state.setStatus(Status.ABORTED);
//              retireTransaction(state, true);
              throw new IOException(e.toString());
           }
          ...
          if (LOG.isTraceEnabled()) LOG.trace("TrxRegionEndpoint coprocessor: commit - txId " + transactionId + ", Executing delete directly to m_Region");
           try {
             m_Region.delete(delete);
              ...
              LOG.warning("TrxRegionEndpoint coprocessor: commit  - txId " + transactionId + ", Executing delete caught an exception " + e.toString());
//              state.setStatus(Status.ABORTED);
//              retireTransaction(state, true);
              throw new IOException(e.toString());
           }
