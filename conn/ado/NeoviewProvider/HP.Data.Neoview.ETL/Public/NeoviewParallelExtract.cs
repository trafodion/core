...
namespace HP.Data.ETL
{
    ...
    /// </summary>
    public class HPDbParallelExtract : IDisposable
    {
        ...
        public HPDbDataReader [] Execute()
        {
            ...
            this._producer = new HPDbConnection(csb.ConnectionString);
            this._producer.Open();
 ...
 */         cmd.CommandText = "get service";
            ...
            HPDbDataReader[] readers = new HPDbDataReader[this.ParallelStreams];
        ...
        {
            HPDbDataReader dr = this._consumers[1].DataReader;
