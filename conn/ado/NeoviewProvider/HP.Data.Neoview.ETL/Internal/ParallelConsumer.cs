...
namespace HP.Data.ETL
{
    ...
    {
        private HPDbParallelExtract _extractor;

        private HPDbConnection _conn;
        private HPDbCommand _cmd;
        private HPDbDataReader _dr;
        ...
        public ParallelConsumer(HPDbParallelExtract extractor, string connectionString, string commandText, int id)
        {
        ...
        public HPDbDataReader DataReader
        {
            get
            {
                return this._dr;
        ...
        private void ExecuteProc()
        {
            try
            {
                this._conn = new HPDbConnection(this._connectionString);
                this._conn.Open();
