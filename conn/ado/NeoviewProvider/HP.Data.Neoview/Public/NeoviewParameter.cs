...
namespace HP.Data
{
    ...
    /// </summary>
    public sealed class HPDbParameter : DbParameter, IDbDataParameter, ICloneable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the HPDbParameter class.
        /// </summary>
        public HPDbParameter()
            : this(string.Empty, null)
        {
        }

        /// <summary>
        /// Initializes a new instance of the HPDbParameter class that uses the parameter name and the data type.
        /// </summary>
        /// <param name="name">The name of the parameter to map.</param>
        /// <param name="dataType">One of the HPDbDbType values.</param>
        /// <exception cref="ArgumentException">The value supplied in the dataType parameter is an invalid back-end data type.</exception>
        public HPDbParameter(string name, HPDbDbType dataType)
        {
            if (HPDbTrace.IsPublicEnabled)
            {
                HPDbTrace.Trace(null, TraceLevel.Public, name, dataType);
            }
            ...
            if (dataType.Equals((HPDbDbType)0))
            {
                this._value = 0;
                dataType = HPDbDbType.Undefined; // make sure we dont get the invalid value exception
            }

            if (!Enum.IsDefined(typeof(HPDbDbType), dataType))
            {
                string msg = HPDbResources.FormatMessage(HPDbMessage.InvalidHPDbDbType, dataType);
                HPDbException.ThrowException(null, new ArgumentException(msg));
            }
        ...
        /// <summary>
        /// Initializes a new instance of the HPDbParameter class that uses the parameter name and a value of the new HPDbParameter.
        /// </summary>
        /// <param name="name">The name of the parameter to map.</param>
        /// <param name="value">An Object that is the value of the HPDbParameter.</param>
        public HPDbParameter(string name, object value)
        {
            if (HPDbTrace.IsPublicEnabled)
            {
                HPDbTrace.Trace(null, TraceLevel.Public, name, value);
            }

            this._descriptor = new Descriptor() { HPDbDataType = HPDbDbType.Undefined };
            this._dataRowVersion = DataRowVersion.Default;
            this._parameterName = name;
            this._value = value;
            this._verified = false;
        ...
        /// <summary>
        /// Initializes a new instance of the HPDbParameter class that uses the parameter name, the HPDbDbType, and the size.
        /// </summary>
        /// <param name="name">The name of the parameter to map.</param>
        /// <param name="dataType">One of the HPDbDbType values. </param>
        /// <param name="size">The length of the parameter.</param>
        /// <exception cref="ArgumentException">The value supplied in the dataType parameter is an invalid back-end data type.</exception>
        public HPDbParameter(string name, HPDbDbType dataType, int size)
            : this(name, dataType)
        {
            this.Size = size;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the HPDbParameter class that uses the parameter name, the HPDbDbType, the size, and the source column name.
        /// </summary>
        /// <param name="name">The name of the parameter to map.</param>
        /// <param name="dataType">One of the HPDbDbType values.</param>
        /// <param name="size">The length of the parameter.</param>
        ...
        /// <exception cref="ArgumentException">The value supplied in the dataType parameter is an invalid back-end data type.</exception>
        public HPDbParameter(string name, HPDbDbType dataType, int size, string srcColumn)
            : this(name, dataType)
        {
            this.Size = size;
        ...
        /// <summary>
        /// Initializes a new instance of the HPDbParameter class that uses the parameter name, the type of the parameter, the size of the parameter, a ParameterDirection, the precision of the parameter, the scale of the parameter, the source column, a DataRowVersion to use, and the value of the parameter.
        /// </summary>
        /// <param name="name">The name of the parameter to map.</param>
        /// <param name="dbType">One of the HPDbDbType values.</param>
        /// <param name="size">The length of the parameter. </param>
        ...
        /// <summary>
        /// Gets or sets the encoding of the HPDbParameter.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the HPDbDbType of the parameter.
        /// </summary>
        [DbProviderSpecificTypePropertyAttribute(true)]
        public HPDbDbType HPDbDbType
        {
            get
            {
        ...
        /// <summary>
        /// Gets or sets the name of the HPDbParameter.
        /// </summary>
        ...
        /// <summary>
        /// Resets the type associated with this HPDbParameter.
        /// </summary>
        ...
        {
            this._verified = false;
            this.HPDbDbType = HPDbDbType.Varchar;
        }

        #region ICloneable

        /// <summary>
        /// Makes a copy of the HPDbParameter.
        /// </summary>
        /// <returns>A copy of this HPDbParameter object.</returns>
        object ICloneable.Clone()
        {
            HPDbParameter clone = new HPDbParameter(
                this._parameterName, 
                this.HPDbDbType, 
                this.Size, 
                this.Direction,
