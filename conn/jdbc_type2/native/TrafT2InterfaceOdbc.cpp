...
//#include "org_trafodion_jdbc_t2_InterfaceNativeConnect.h"
//#include "org_trafodion_jdbc_t2_InterfaceNativeStmt.h"
...
void DISPATCH_SQLRequest(short operation_id, Long &stmtId, const char *inBuffer);
void SQLPREPARE_IOMessage(short operation_id, Long &stmtId, const char *inBuffer);
void SQLEXECUTE_IOMessage(short operation_id, Long &stmtId, const char *inBuffer);
void SQLFETCH_IOMessage(short operation_id, Long &stmtId, const char *inBuffer);

JNIEXPORT jbyteArray JNICALL Java_org_trafodion_jdbc_t2_TrafT2NativeInterface_processRequest
  (JNIEnv *jenv, jclass jobj, jshort executeAPI, jlong stmtId, jbyteArray jInValueArray)
{
	...
	DISPATCH_SQLRequest(operation_id, stmtHandle, inBuffer);
		...
		)
{
	...
	case SRVR_API_SQLFETCH_ROWSET:
		SQLFETCH_IOMessage(operation_id, stmtId, inBuffer);
		break;
