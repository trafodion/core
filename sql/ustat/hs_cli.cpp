...
NABoolean HSTranMan::InTransaction()
  {
    return ((SQL_EXEC_Xact(SQLTRANS_STATUS, 0) == 0) ? TRUE : FALSE);
  }
...
#else // NA_USTAT_USE_STATIC not defined, use dynamic query
    //Note: stack-allocated object here causes seg fault on bad 'this' ptr when entering this fn
    //HSinsertHist histRS(histTable_);
