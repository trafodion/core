						...
						SP_ERROR_STRUCT* /* error */  )
{
  ...
  strcpy(&((format++)->COLUMN_DEF[0]), "Text  			CHAR(4096 BYTES) character set utf8");
  ...
  strcpy(&((format++)->COLUMN_DEF[0]), "Param_types   		CHAR(1024 BYTES) character set utf8");
  strcpy(&((format++)->COLUMN_DEF[0]), "Compilation_time	INT UNSIGNED");
  strcpy(&((format++)->COLUMN_DEF[0]), "Average_hit_time	INT UNSIGNED");
  strcpy(&((format++)->COLUMN_DEF[0]), "Shape    		CHAR(1024 BYTES) character set utf8");
...
{
  strcpy(&((format++)->COLUMN_DEF[0]), "plan_id     		LARGEINT");
  strcpy(&((format++)->COLUMN_DEF[0]), "hkey  			CHAR(4096 BYTES) character set utf8");
  strcpy(&((format++)->COLUMN_DEF[0]), "skey        		CHAR(4096 BYTES) character set utf8");
  strcpy(&((format++)->COLUMN_DEF[0]), "num_hits  		INT UNSIGNED");
  strcpy(&((format++)->COLUMN_DEF[0]), "num_PLiterals  		INT UNSIGNED");
  strcpy(&((format++)->COLUMN_DEF[0]), "PLiterals	CHAR(4096 BYTES) character set utf8");
  strcpy(&((format++)->COLUMN_DEF[0]), "num_NPLiterals        	INT UNSIGNED");
  strcpy(&((format++)->COLUMN_DEF[0]), "NPLiterals   CHAR(4096 BYTES) character set utf8");
  return SP_SUCCESS;
}
