...
HTC_RetCode HTableClient_JNI::startScan(Int64 transID, const Text& startRowID, 
   const Text& stopRowID, const LIST(NAString) & cols, Int64 timestamp, 
...
// 
//////////////////////////////////////////////////////////////////////////////
HTC_RetCode HTableClient_JNI::startGet(Int64 transID, const NAString& rowID, 
      const LIST(NAString) & cols, Int64 timestamp)
{
...
// 
//////////////////////////////////////////////////////////////////////////////
HTC_RetCode HTableClient_JNI::startGets(Int64 transID, const LIST(NAString)& rowIDs, 
	const LIST(NAString) & cols, Int64 timestamp)
{
...
// 
//////////////////////////////////////////////////////////////////////////////
HTC_RetCode HTableClient_JNI::deleteRow(Int64 transID, HbaseStr &rowID, const LIST(NAString)& cols, Int64 timestamp)
{
