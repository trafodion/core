...
public:
  ...
  HTC_RetCode startScan(Int64 transID, const Text& startRowID, const Text& stopRowID, const LIST(NAString) & cols, Int64 timestamp, bool cacheBlocks, Lng32 numCacheRows,
                        NABoolean preFetch,
			...
			char * tmpLoc = NULL,
			Lng32 espNum = 0);
  HTC_RetCode startGet(Int64 transID, const HbaseStr& rowID, const LIST(NAString) & cols, 
		Int64 timestamp);
  HTC_RetCode startGets(Int64 transID, const LIST(HbaseStr)& rowIDs, const LIST(NAString) & cols, 
		Int64 timestamp);
  HTC_RetCode deleteRow(Int64 transID, HbaseStr &rowID, const LIST(NAString)& columns, Int64 timestamp);
