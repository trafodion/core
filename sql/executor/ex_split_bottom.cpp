  ...
  if (splitBottomTdb.skewInfo_)
    {
      ...
      for (Int32 skewArrayIdx=0;
           skewArrayIdx < splitBottomTdb.skewInfo_->getNumSkewHashValues();
           skewArrayIdx++)
      {
        Int64 sv =
            splitBottomTdb.skewInfo_->getSkewHashValues()[skewArrayIdx];
