...
private:
  ...
  // havePrivateCbServer_ is true.  Otherwise it is owned by cliGlobals.
  // We will use the cliGlobals's IpcServer for the normal case that
  ...
  // concurrently share the cliGlobals IpcServer, but for simplicity in
