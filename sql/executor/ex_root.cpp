...
void ex_root_tcb::registerCB(ComDiagsArea *&diagsArea)
{
  ...
  // Cancel broker is not available, e.g., Windows.
  ...
  RtsQueryId *rtsQueryId = new (cliGlobals->getIpcHeap()) 
                         RtsQueryId( cliGlobals->getIpcHeap(), qid, qidLen); 
  ...
  QueryStarted *queryStarted = 
    new (cliGlobals->getIpcHeap()) 
      QueryStarted(rtsHandle, cliGlobals->getIpcHeap(), 
  ...
  {
    queryStartedStream_  = new (cliGlobals->getIpcHeap())
          QueryStartedMsgStream(cliGlobals->getEnvironment(), this);
...
#pragma warning (disable : 4291)
  ...
  QueryFinished *queryFinished = 
    new (cliGlobals->getIpcHeap()) QueryFinished( rtsHandle, 
...
#pragma warning (default : 4291)
  ...
  {
    queryFinishedStream_  = new (cliGlobals->getIpcHeap())
          QueryFinishedMsgStream(cliGlobals->getEnvironment(), this);
