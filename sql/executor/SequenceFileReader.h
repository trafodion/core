...
public:
  ...
  SFW_RetCode    hdfsDeletePath(const std::string& delPath);
  ...
  SFW_RetCode    createSnapshot( const std::string&  tableName, const std::string&  snapshotName);
  SFW_RetCode    deleteSnapshot( const std::string&  snapshotName);
  SFW_RetCode    verifySnapshot( const std::string&  tableName, const std::string&  snapshotName, NABoolean & exist);
  SFW_RetCode    release();
  SFW_RetCode    setArchPermissions( const std::string&  tabName);
