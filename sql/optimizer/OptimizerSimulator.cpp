 ...
 heap_(heap)
{
  ...
  // Init log4cpp logging
  CommonLogger::instance().initLog4cpp("log4cpp.trafodion.osim.config");
}
...
NABoolean OptimizerSimulator::isClusterInfoInitialized()
{
  return clusterInfoInitialized_;
}

void OptimizerSimulator::setClusterInfoInitialized(NABoolean b)
{
  clusterInfoInitialized_ = b;
}
