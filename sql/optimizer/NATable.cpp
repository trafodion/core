...
NATable * NATableDB::getCachedNATable(CorrName & corNm)
{
  const ExtendedQualName* toFind = &(corNm.getExtendedQualNameObj());
  //get the cached NATable entry
  NATable * cachedNATable = NAKeyLookup<ExtendedQualName,NATable>::get(toFind);
