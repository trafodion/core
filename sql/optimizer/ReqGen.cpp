...
/*
STOP to be removed
               // If the skew property on the partfunc is ANY, set it to
               // the newly added skew property
               if ( skpf->getSkewProperty().isAnySkew() ) {

                  ((SkewedDataPartitioningFunction*)partFunc) ->
                         setSkewProperty(addedSkewProperty_);
