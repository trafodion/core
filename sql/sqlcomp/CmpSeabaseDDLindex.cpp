  ...
  while (i < totalColCount)
    {
      ...
      // columns, then those columns have alread been added in the loop above
				       ...
				       NAString &currCatName, NAString &currSchName)
{
      ...
      createIndexNode->getSaltOptions()->getLikeTable())
  {
    ...
    {
      *CmpCommon::diags() << DgSqlCode(-1201)
                           << DgString0(extIndexName);
       deallocEHI(ehi);
       processReturn();
       return;
    ...
    {
       *CmpCommon::diags() << DgSqlCode(-1202)
  ...
  NAString hco;
  setupHbaseOptions(createIndexNode->getHbaseOptionsClause(), 
                    numSplits,
