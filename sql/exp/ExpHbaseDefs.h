...
enum HbaseOptionEnum
  {
    ...
    HBASE_PREFIX_LENGTH_KEY = 14,
    HBASE_EVICT_BLOCKS_ON_CLOSE = 15,
    HBASE_KEEP_DELETED_CELLS = 16,
    HBASE_REPLICATION_SCOPE = 17, // items here and above are column family level
    HBASE_MAX_FILESIZE = 18,  // items below are on a table level
    HBASE_COMPACT = 19,
    HBASE_DURABILITY = 20,
